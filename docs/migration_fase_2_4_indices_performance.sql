...
-- ✅ Documentos
CREATE INDEX idx_documentos_empresa_status ON documentos(empresa_id, status);
CREATE INDEX idx_documentos_empresa_data_emissao ON documentos(empresa_id, data_emissao);
